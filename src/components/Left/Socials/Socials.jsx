    ...
    <ul className='mt-8 flex items-center' aria-label='Social media'>
      ...
      <li className='mr-5 shrink-0 text-xs'>
        ...
        >
          ...
          >
            <path
              d="M31.462 23.534c-1.73 0-3.134 1.404-3.134 3.134v74.664c0 1.73 1.404 3.134 3.134 3.134h1.575c1.73 0 3.134-1.404 3.134-3.134V68.943L87.63 103.9c1.354 1.085 3.393.165 3.393-1.612v-3.46a3.134 3.134 0 0 0-1.134-2.418L42.177 64.01l47.708-36.4a3.134 3.134 0 0 0 1.134-2.418v-3.46c0-1.777-2.04-2.697-3.393-1.612L36.171 59.312V26.668c0-1.73-1.404-3.134-3.134-3.134h-1.575z"
            />
          </svg>
        </a>
      </li>
